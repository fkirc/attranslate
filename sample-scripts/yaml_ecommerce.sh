...
node search_replace.js "yaml/es_ecommerce.yml" "es:" "en:\n" # preprocessing
attranslate "${COMMON_ARGS[@]}" --targetFile=yaml/es_ecommerce.yml --targetLng=es
node search_replace.js "yaml/es_ecommerce.yml" "en:" "es:\n" # postprocessing

node search_replace.js "yaml/de_ecommerce.yml" "de:\n" "en:\n" # preprocessing
attranslate "${COMMON_ARGS[@]}" --targetFile=yaml/de_ecommerce.yml --targetLng=de
node search_replace.js "yaml/de_ecommerce.yml" "en:\n" "de:\n" # postprocessing
