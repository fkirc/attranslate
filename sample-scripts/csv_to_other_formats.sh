...
attranslate --overwriteOutdated=false --srcFormat=csv --srcFile=csv/google-docs.csv --srcLng=de --targetFormat=nested-json --targetFile=csv/de.json --targetLng=de --service=sync-without-translate

attranslate --overwriteOutdated=false --srcFormat=csv --srcFile=csv/translations.csv --srcLng=en --targetFormat=flat-json --targetFile=csv/en.json --targetLng=en --service=sync-without-translate
attranslate --overwriteOutdated=false --srcFormat=csv --srcFile=csv/translations.csv --srcLng=en --targetFormat=ios-strings --targetFile=csv/en.strings --targetLng=en --service=sync-without-translate
